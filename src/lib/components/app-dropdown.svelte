...
<Dialog.Root bind:open={showNoAccessModal}>
	<Dialog.Portal>
		...
		>
			<Dialog.Title class="text-lg font-bold text-red-600 mb-2">Access Denied</Dialog.Title>

			<Dialog.Description class="text-gray-800 mb-4 text-sm">
				We're sorry, but you do not currently have permission to view this information. For
				assistance or to request access, please contact
